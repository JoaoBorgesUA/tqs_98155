...
class AddressResolverTest {
    ...
    void whenResolveAlboiGps_returnCaisAlboiAddress() throws ParseException, IOException, URISyntaxException {
        ...
        // e.g.
        // Optional<Address> result = resolver.findAddressForLocation(40.640661,
        // -8.656688);

        // return
        // assertEquals( result, new Address( "Cais do Alboi", "Glória e Vera Cruz",
        // "Centro", "3800-246", null) );
    ...
    public void whenBadCoordidates_thenReturnNoValidAddress() throws IOException, URISyntaxException, ParseException {
        ...
        String mock = "{\"info\":{\"statuscode\":0,\"copyright\":{\"text\":\"\u00A9 2022 MapQuest, Inc.\",\"imageUrl\":\"http://api.mqcdn.com/res/mqlogo.gif\",\"imageAltText\":\"\u00A9 2022 MapQuest, Inc.\"},\"messages\":[]},\"options\":{\"maxResults\":1,\"thumbMaps\":true,\"ignoreLatLngInput\":false},\"results\":[{\"providedLocation\":{\"latLng\":{\"lat\":-300.0,\"lng\":-810.0}},\"locations\":[]}]}";
        when(HttpClient.doHttpGet(contains("location=-300.000000%2C-810.000000"))).thenReturn(mock);
